...
namespace loginserver
{
    namespace network
    {
        namespace crypto
        {
            ...
            void Blowfish::SetKey(uint8_t* aKey)
            {
            ...
            void Blowfish::initArrays()
            {
                ...
                {
                    Cipher(b, 8);
                    m_pArray[i] = byteArrayToInteger(b);
                    m_pArray[i + 1] = byteArrayToInteger(b + 4);
                }

                for (int i = 0; i < 4; i++)
                {
                    initSBox(b, m_sBoxes[i]);
                }
            }
            ...
            void Blowfish::initSBox(uint8_t* aBase, uint32_t* aSBox)
            {
                for (int j = 0; j < 256; j += 2)
                {
                    ...
                    aSBox[j + 1] = byteArrayToInteger(aBase + 4);
                }
            }
